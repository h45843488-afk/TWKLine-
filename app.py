...
"""
    ...
    html_table = f"""
    <div class="stock-info-card" style="padding: 10px;">
        ...
        <table style="width: 100%; font-size: 12px; border-collapse: collapse; font-family: monospace;">
            <thead>
                <tr style="border-bottom: 1px solid #444444; color: #888888; text-align: right;">
                    <th style="text-align: left; padding-bottom: 4px;">日期</th>
                    <th style="padding-bottom: 4px;">外資</th>
                    <th style="padding-bottom: 4px;">投信</th>
                    <th style="padding-bottom: 4px;">自營</th>
                    <th style="padding-bottom: 4px;">合計</th>
                </tr>
            </thead>
            <tbody>
                {table_rows}
